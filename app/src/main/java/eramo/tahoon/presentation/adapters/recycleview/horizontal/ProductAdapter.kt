...
import eramo.tahoon.databinding.ItemProductBinding
...
class ProductAdapter @Inject constructor() :
    ListAdapter<MyProductModel, ProductAdapter.ProductViewHolder>(PRODUCT_COMPARATOR) {
...
//                }
                ...
                itemProductIvFav.setOnClickListener {
                    ...
                    listener.onProductFavouriteClick(model, model.isFav == 1)
                }
...
//                else binding.itemProductIvFav.setImageResource(R.drawable.ic_heart)
    ...
    interface OnItemClickListener {
        fun onProductClick(model: MyProductModel)
        fun onProductFavouriteClick(model: MyProductModel, isFav: Boolean)
    }
