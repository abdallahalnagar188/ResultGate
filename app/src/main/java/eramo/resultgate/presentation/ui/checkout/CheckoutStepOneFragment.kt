...
import eramo.resultgate.databinding.FragmentCheckoutStepOneBinding
import eramo.resultgate.domain.model.request.CheckoutModel
import eramo.resultgate.presentation.adapters.recycleview.vertical.CheckoutAdapter
import eramo.resultgate.presentation.ui.dialog.LoadingDialog
import eramo.resultgate.presentation.ui.dialog.MyAddressesDialogArgs
...
import eramo.resultgate.util.StringIdShipping
import eramo.resultgate.util.UserUtil
import eramo.resultgate.util.formatPrice
import eramo.resultgate.util.hideSoftKeyboard
