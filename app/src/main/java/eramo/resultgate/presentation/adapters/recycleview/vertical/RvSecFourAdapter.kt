...
class RvSecFourAdapter @Inject constructor() :
    ListAdapter<MyProductModel, RvSecFourAdapter.ProductViewHolder>(PRODUCT_COMPARATOR) {
            ...
            binding.root.setOnClickListener {
                if (bindingAdapterPosition != RecyclerView.NO_POSITION) {
                    getItem(bindingAdapterPosition).let {
                        listener.onSecFourProductClick(it)
                    }
                }
            }
        }
...
//                }
                ...
                itemProductIvFav.setOnClickListener {
                    ...
                    listener.onSecFourProductFavouriteClick(model, model.isFav == 1)
                }
...
//                else binding.itemProductIvFav.setImageResource(R.drawable.ic_heart)
    ...
    interface OnItemClickListener {
        fun onSecFourProductClick(model: MyProductModel)
        fun onSecFourProductFavouriteClick(model: MyProductModel, isFav: Boolean)
    }
