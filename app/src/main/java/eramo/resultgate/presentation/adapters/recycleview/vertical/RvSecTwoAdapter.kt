...
class RvSecTwoAdapter @Inject constructor() :
    ListAdapter<MyProductModel, RvSecTwoAdapter.ProductViewHolder>(PRODUCT_COMPARATOR) {
            ...
            binding.root.setOnClickListener {
                if (bindingAdapterPosition != RecyclerView.NO_POSITION) {
                    getItem(bindingAdapterPosition).let {
                        listener.onSecTwoProductClick(it)
                    }
                }
            }
        }
...
//                }
                ...
                itemProductIvFav.setOnClickListener {
                    ...
                    listener.onSecTwoProductFavouriteClick(model, model.isFav == 1)
                }
...
//                else binding.itemProductIvFav.setImageResource(R.drawable.ic_heart)
    ...
    interface OnItemClickListener {
        fun onSecTwoProductClick(model: MyProductModel)
        fun onSecTwoProductFavouriteClick(model: MyProductModel, isFav: Boolean)
    }
