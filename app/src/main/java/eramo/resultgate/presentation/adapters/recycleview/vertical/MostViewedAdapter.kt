...
import eramo.resultgate.databinding.ItemProductHoriBinding
...
class MostViewedAdapter @Inject constructor() :
    ListAdapter<MyProductModel, MostViewedAdapter.ProductViewHolder>(PRODUCT_COMPARATOR) {
            ...
            binding.root.setOnClickListener {
                if (bindingAdapterPosition != RecyclerView.NO_POSITION) {
                    getItem(bindingAdapterPosition).let {
                        listener.onMostViewedProductClick(it)
                    }
                }
            }
        }
...
//                }
                ...
                itemProductIvFav.setOnClickListener {
                    ...
                    listener.onMostViewedProductFavouriteClick(model, model.isFav == 1)
                }
...
//                else binding.itemProductIvFav.setImageResource(R.drawable.ic_heart)
    ...
    interface OnItemClickListener {
        fun onMostViewedProductClick(model: MyProductModel)
        fun onMostViewedProductFavouriteClick(model: MyProductModel, isFav: Boolean)
    }
