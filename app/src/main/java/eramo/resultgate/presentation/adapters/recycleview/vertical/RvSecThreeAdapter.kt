...
class RvSecThreeAdapter @Inject constructor() :
    ListAdapter<MyProductModel, RvSecThreeAdapter.ProductViewHolder>(PRODUCT_COMPARATOR) {
            ...
            binding.root.setOnClickListener {
                if (bindingAdapterPosition != RecyclerView.NO_POSITION) {
                    getItem(bindingAdapterPosition).let {
                        listener.onSecThreeProductClick(it)
                    }
                }
            }
        }
...
//                }
                ...
                itemProductIvFav.setOnClickListener {
                    ...
                    listener.onSecThreeProductFavouriteClick(model, model.isFav == 1)
                }
...
//                else binding.itemProductIvFav.setImageResource(R.drawable.ic_heart)
    ...
    interface OnItemClickListener {
        fun onSecThreeProductClick(model: MyProductModel)
        fun onSecThreeProductFavouriteClick(model: MyProductModel, isFav: Boolean)
    }
