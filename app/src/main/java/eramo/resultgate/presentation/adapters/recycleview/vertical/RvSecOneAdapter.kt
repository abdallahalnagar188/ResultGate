...
class RvSecOneAdapter @Inject constructor() :
    ListAdapter<MyProductModel, RvSecOneAdapter.ProductViewHolder>(PRODUCT_COMPARATOR) {
            ...
            binding.root.setOnClickListener {
                if (bindingAdapterPosition != RecyclerView.NO_POSITION) {
                    getItem(bindingAdapterPosition).let {
                        listener.onSecOneProductClick(it)
                    }
                }
            }
        }
...
//                }
                ...
                itemProductIvFav.setOnClickListener {
                    ...
                    listener.onSecOneProductFavouriteClick(model, model.isFav == 1)
                }
...
//                else binding.itemProductIvFav.setImageResource(R.drawable.ic_heart)
    ...
    interface OnItemClickListener {
        fun onSecOneProductClick(model: MyProductModel)
        fun onSecOneProductFavouriteClick(model: MyProductModel, isFav: Boolean)
    }
